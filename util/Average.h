...
#include "/home/morsedc/tghasi/CollectiveVariable-plugin/util/AverageStage.h"                    // base class
...
namespace Util
{
   ...
   */
   class Average : public AverageStage
   {
   ...
   */
   ...
   {
      if (iBlock_ == 0) {
         std::cout<<"Attempt to get block average with no data\n";
      }
